export const exnihiloPoolAbi = [
    ...
    {
      "inputs": [],
      "name": "settlementGuardedUntilBlock",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "",
