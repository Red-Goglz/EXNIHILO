  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        collapsed: false,
        items: [
          { text: "Opening a Position", link: "/trading/opening" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Funding", link: "/positions/funding" },
        ],
      },
      {
        ...
        collapsed: false,
        items: [
          { text: "Running a Pool", link: "/lp/ownership" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Pricing & Reserves", link: "/markets/pricing" },
        ],
      },
      {
        text: "Protocol",
