...
Traditional perps require collateral, charge funding rates, and liquidate positions. EXNIHILO positions only require the trade amount, have no funding rates, and are never liquidated. Your maximum loss is your initial trade size.
...
No. There is no liquidation engine. Your position stays open until you choose to close it, or the LP force-realizes it.

### What's my maximum loss?
Your maximum loss is the USDC you put in (your position size). You cannot lose more than that.
...
Your position is settled and the NFT is burned. The remaining value stays in the pool — you do not receive USDC. This is an LP risk management tool.
...
The LP can withdraw liquidity and force-realize positions. However, the reserve invariant prevents withdrawing more than the backed reserves. Traders should assess LP trust before opening large positions.
