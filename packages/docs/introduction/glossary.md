...
| **BNPL** | Buy Now, Pay Later — the trading model where you only pay your trade amount, with no additional collateral or margin. |
...
| **Force realize** | LP authority to settle an open position early, returning collateral and burning the position NFT. |
